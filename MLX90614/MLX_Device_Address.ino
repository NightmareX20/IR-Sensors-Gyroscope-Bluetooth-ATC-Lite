/*
*  From Arduino Forum: http://forum.arduino.cc/index.php?topic=54170.0
*  I am just putting this info together that I utilized for my own * * * applicaitons. So if you find my Github you don't have to search so * * much over the internet looking for something that works with MLX IR * * Temp sensors
*/
#include <i2cmaster.h>
